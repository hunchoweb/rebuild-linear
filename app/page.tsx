...
import { LinearWorkflows } from "../components/sections/linear-work-flow";
...
export default function Homepage() {
  return (
    <>
      ...
      <div
        className={classNames(
          "mask-radial-faded pointer-events-none relative z-[-1] mt-[-28.8rem] mb-[-12.8rem] h-[60rem] rotate-180 overflow-hidden",
          "[--color:#7877C6] before:absolute before:inset-0 before:bg-radial-faded before:opacity-[0.4]",
          "after:absolute after:top-1/2 after:-left-1/2 after:h-[142.8%] after:w-[200%] after:rounded-[50%] after:border-t after:border-[rgba(120,_119,_198,_0.4)] after:bg-background"
        )}
      >
